const AppData = {
    ...
    suggestedHabits: ["Picie 2l wody", "Spacer 30 minut", "Bez social mediów rano", "Joga lub rozciąganie", "Nauka 5 nowych słówek", "Pisanie dziennika", "Planowanie następnego dnia", "Zdrowy posiłek", "Kontakt z naturą", "Poświęcenie czasu na hobby", "Słuchanie podcastu rozwojowego", "Praktyka uważności (mindfulness)"]
};
